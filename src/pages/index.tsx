          ...
          <div className="flex flex-1 items-center justify-end md:justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="sm:flex sm:gap-4">
                <Link
                  className="block rounded-md bg-gray-900 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-gray-600"
                  href="/login"
                >
                  Giriş Yap
                </Link>
                ...
                <Link
                  className="hidden rounded-md bg-gray-500 px-5 py-2.5 text-sm font-medium text-white transition hover:text-black sm:block"
                  href="/register"
                >
                  Kayıt Ol
                </Link>
        ...
        <div className="container mx-auto py-9 md:py-12 lg:py-24">
          <div className="relative mx-4">
            ...
            <img
              src="hero.jpg"
              alt="clothes"
              className="hidden h-full w-full sm:block lg:hidden"
            />
            <img
              src="hero.jpg"
              alt="clothes"
            ...
            />
            <div className="absolute left-0 top-0 z-10 mx-4 mt-36 flex flex-col items-start sm:mx-0 sm:mt-0 sm:justify-start sm:py-20 sm:pl-14 md:py-28 lg:py-20 xl:py-28">
              <h1 className="text-4xl font-semibold text-white sm:w-8/12 sm:text-5xl lg:text-6xl">
                Tarzınızı Keşfedin, Modayı Yaşayın!
              </h1>
              <p className="mt-4 text-base leading-normal text-white sm:mt-5 sm:w-5/12">
                En yeni ve trend ürünlerle tarzınızı yansıtın
              </p>
              <button className="mt-8 hidden bg-white px-8 py-4 text-base font-medium text-black hover:bg-black hover:text-white focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-offset-2 sm:flex">
                Keşfet
              </button>
            </div>
            <button className="absolute bottom-0 mt-8 flex w-full items-center justify-center bg-gray-800 py-4 text-base font-medium text-white hover:bg-black focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-offset-2 dark:bg-white dark:text-gray-800 sm:hidden">
              Keşfet
            </button>
          </div>
        </div>
      </div>
      <div className="container mx-auto px-4 px-4 py-12 sm:px-6 lg:px-12 xl:px-20">
        <div className="flex flex-col items-center justify-center">
          <div className="mt-8 flex flex-wrap items-center justify-center gap-8 sm:gap-10">
            <p className="cursor-pointer text-base leading-4 text-gray-800 hover:text-gray-500">
              Hakkında
            </p>
            <p className="cursor-pointer text-base leading-4 text-gray-800 hover:text-gray-500">
              İletişim
          ...
          <div className="mt-6 flex items-center">
            <p className="text-base leading-4 text-gray-800">
              2023 <span className="font-semibold">Lorem</span>
            </p>
